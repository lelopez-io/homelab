...
This repository accompanies tutorial series documenting the complete build process: [Building with Talos](https://lelopez.io/blog/homelab-v2-00-talos-kubernetes-homelab-series) (V2) and [Security Hardening](https://lelopez.io/blog/homelab-v3-00-security-hardening-series) (V3), plus standalone guides.
...
| #   | Article                                                                                                    | Version                                                         |
| --- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| 00  | [Security Hardening Series](https://lelopez.io/blog/homelab-v3-00-security-hardening-series)               | [v2.0.0](https://github.com/lelopez-io/homelab/tree/v2.0.0)     |
...
| 15  | [GPG Signed Commits](https://lelopez.io/blog/homelab-v3-15-gpg-signed-commits)                             |                                                                 |
| 16  | [Image Digest Pinning](https://lelopez.io/blog/homelab-v3-16-image-digest-pinning)                         |                                                                 |

### Standalone Guides

| Article                                                                                              | Version                                                       |
| ---------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| [Plex FileBrowser Upload](https://lelopez.io/blog/homelab-guide-plex-filebrowser-upload)             | [v1.12.0](https://github.com/lelopez-io/homelab/tree/v1.12.0) |
| [Plex Remote Access via frp](https://lelopez.io/blog/homelab-guide-plex-remote-access-frp)           | [v1.13.0](https://github.com/lelopez-io/homelab/tree/v1.13.0) |
